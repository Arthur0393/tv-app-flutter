                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      if (snapshot.hasError) {
                        ...
                        return const Text('Ocurrió un error (like you 7u7) al cargar los datos');
                      } else {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items:  const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            label: 'Mejores momentos de los idolos 0w0',
          ),
          BottomNavigationBarItem(
            icon: Icon(
            ...
            label: 'Recomendaciones de videos ramdom :P',
          ),
        ],
        backgroundColor: Colors.blue,
        unselectedItemColor: Colors.black54,
        unselectedLabelStyle: const TextStyle(color: Colors.blueGrey, fontSize: 14),
